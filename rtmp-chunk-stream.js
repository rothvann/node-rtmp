...
class RmtpChunkStream {
    ...
    constructor() {
        ...
        this.parseBasicHeader = this.parseBasicHeader.bind(this);
    ...
    function parseBasicHeader(chunk) {
        let basic_header = chunk.readUIntBE(0, 1);
    ...
    function parseChunk(chunk) {
        let parsed_chunk = {basic_header: parseBasicHeader(chunk)};
        
        parsed_chunk['message_header'] = parseMessageHeader(parsed_chunk['fmt'], chunk);
     
        if(parsed_chunk['basic_header']['cs_id'] == 2 && parsed_chunk['message_header']['stream_id'] == 0) {
    ...
    function parseProtocolControlMessage(parsed_chunk, chunk) {
